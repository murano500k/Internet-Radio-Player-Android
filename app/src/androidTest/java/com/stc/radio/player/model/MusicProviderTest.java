...
public class MusicProviderTest {
    ...
    public void testGetMusicsByGenre() throws Exception {
        int count = 0;
        for (MediaMetadataCompat metadata: provider.getMusicsById()) {
    ...
    public void testGetMusicsByInvalidGenre() throws Exception {
        assertFalse(provider.getMusicsById().iterator().hasNext());
    }

    @Test
    public void testSearchBySongTitle() throws Exception {
        int count = 0;
        for (MediaMetadataCompat metadata: provider.searchMusic("Romantic")) {
    ...
    public void testSearchByInvalidSongTitle() throws Exception {
        assertFalse(provider.searchMusic("XYZ").iterator().hasNext());
    }
