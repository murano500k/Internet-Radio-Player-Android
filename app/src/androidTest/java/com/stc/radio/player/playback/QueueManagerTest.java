...
public class QueueManagerTest {
    ...
    public void testIsSameBrowsingCategory() throws Exception {
        ...
        List<MediaSessionCompat.QueueItem> queueGenre1 = QueueHelper.getPlayingQueue(
                MediaIDHelper.createMediaID(null, MediaIDHelper.MEDIA_ID_MUSICS_BY_SEARCH, genre1),
                provider);
        List<MediaSessionCompat.QueueItem> queueGenre2 = QueueHelper.getPlayingQueue(
                MediaIDHelper.createMediaID(null, MediaIDHelper.MEDIA_ID_ROOT, genre2),
                provider);
    ...
    public void testSetQueueFromMusic() throws Exception {
        ...
        MediaMetadataCompat metadata = provider.getMusicsById().iterator().next();
        ...
        int count = 0;
        for (MediaMetadataCompat m: provider.getMusicsById()) {
            count++;
        }
